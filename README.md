...
**[Easy Dictate](https://github.com/RuKapSan/easy-dictate)** — Desktop voice-to-text app with AI transcription. Push-to-talk dictation with OpenAI Whisper, Groq, and ElevenLabs. Built with Tauri v2 + Rust.
